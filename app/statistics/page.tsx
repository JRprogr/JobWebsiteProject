...
export default async function StatisticsPage({ searchParams }: PageProps<"/statistics">) {
  ...
  return (
    <PageShell
      ...
      title="Market pulse."
      intro="See how many roles are open, which employers are hiring and how fast the picture changes. Counts come from our own scrapes, so history starts on the day each company was first added."
    >
