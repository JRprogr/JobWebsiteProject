...
const FAQ: { q: string; a: React.ReactNode }[] = [
  ...
  },
  {
    ...
    a: "Each company's own public career page or applicant tracking system — Greenhouse, Lever, Workday, Personio, Teamtailor, Recruitee, BambooHR or Ashby, or a company's own listings page for sources without a public API.",
  },
  {
