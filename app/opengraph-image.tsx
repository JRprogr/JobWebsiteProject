...
export const alt = "DS[Careers] — Space & Defence jobs in Europe";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 22, position: "relative" }}>
          <div style={{ display: "flex", fontSize: 26, color: "#FEDA49", letterSpacing: 3 }}>[ SPACE &amp; DEFENCE JOBS · EUROPE FIRST ]</div>
          <div style={{ display: "flex", fontSize: 128, fontWeight: 800, color: "#FEDA49", lineHeight: 1 }}>DS[Careers]</div>
